...
const SearchScreen = ({navigation}) => {
  return (
    <View style={{flex:1,marginBottom:15,paddingTop:19}}>
      <SearchComponent/>
                ...
                renderItem = {({item,index})=>(
                  ...
                  >
                      ...
                      <View style={styles.textview}>
                        <Text style={{color:colors.Cardbackground,fontSize:18,fontWeight:'bold',justifyContent:'center'}}> {item.name}</Text>
                      </View>
                          </ImageBackground>
                      </View>
